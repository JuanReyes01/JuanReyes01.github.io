<script lang="ts">
	...
	// The graph itself renders fully lit and at rest at HEAD from the first
	// frame — no automatic intro plays (owner decision, v2 direction slice
	// S1: "kill the timeline's automatic epoch sweep").
	...
	// pyfiglet, font "standard" — the merged page keeps the "WORK" header
	// (v2 direction slice S1: the tab is now just "work", the timeline is
	// this page's spine rather than a separate "EXPERIENCE" tab/header).
...
<SeoHead
	...
	description="Career timeline and case studies: Chief AI Officer at Creceré, plus the builds behind CreditBay — AI voice agents, a retrieval-augmented knowledge base, and more."
	path="/work/"
/>
...
>
	...
	<div class="list-meta builds-meta">
